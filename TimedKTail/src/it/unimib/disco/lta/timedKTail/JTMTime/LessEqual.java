 ...
 * @author AlexP
 */
public class LessEqual implements Operation, java.io.Serializable{
    private static final long serialVersionUID = 00000001L;
    private static final Logger logger = LogManager.getLogger(LessEqual.class);
	private long val2;

    
    public LessEqual( long value){
    	this.val2 = value;
    }
