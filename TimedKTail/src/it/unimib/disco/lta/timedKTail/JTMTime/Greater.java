 ...
 * @author AlexP
 */
public class Greater implements Operation , java.io.Serializable{
    private static final long serialVersionUID = 00000001L;
    private static final Logger logger = LogManager.getLogger(Greater.class);
	private long val2;
    
    public Greater(long val2){
    	this.val2 = val2;
    }
