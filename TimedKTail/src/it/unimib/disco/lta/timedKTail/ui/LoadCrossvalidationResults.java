...
public class LoadCrossvalidationResults {
	...
	public static void main(String[] args) throws IOException {
		...
		if ( inference ){
		printTableVectorsWithPrefix("normal_accepted_", destFile);
		

		printTableVectorsWithPrefix("all_AbsoluteClocks_", destFile);
		
		printTableVectorsWithPrefix("all_accepted_AbsoluteClocks_", false,destFile);
		
		
		printTableVectorsWithPrefix("minMax_accepted_", destFile);
		


		printTableVectorsWithPrefix("normal_accepted", destFile);
		
		
		printTableVectorsWithPrefix("minMaxAccepted", destFile);
		

		printTableVectorsWithPrefix("accepted_",false,destFile);
		printTableVectorsWithPrefix("invalid_events_",false,destFile);
		printTableVectorsWithPrefix("invalid_guards_",false,destFile);
		printTableVectorsWithPrefix("missing_clocks_",false,destFile);
		
		printTableVectorsWithPrefix("config_accepted_",false,destFile,"");
		printTableVectorsWithPrefix("config_notAccepted_",false,destFile,"");
		printTableVectorsWithPrefix("config_invalid_events_",false,destFile,"");
		printTableVectorsWithPrefix("config_invalid_guards_",false,destFile,"");
		printTableVectorsWithPrefix("config_missing_clocks_",false,destFile,"");
		
		printTableVectorsWithPrefix("config_avgAccepted_",false,destFile,"");
		printTableVectorsWithPrefix("config_avgNotAccepted_",false,destFile,"");
		
		printTableVectorsWithPrefix("config_invalid_guards_",false,destFile,"");
		
		} else {
		
		printTableVectorsWithPrefix("normal_notAccepted", false, destFile);		
		printTableVectorsWithPrefix("minMaxNotAccepted",false, destFile);
		printTableVectorsWithPrefix("normal_notAccepted_", false,destFile);
		
		printTableVectorsWithPrefix("all_notAccepted_AbsoluteClocks_", false,destFile);
		
		printTableVectorsWithPrefix("minMax_notAccepted_", false,destFile);
		
		printTableVectorsWithPrefix("accepted_",false,destFile,"disturbate_");
		printTableVectorsWithPrefix("invalid_events_",false,destFile,"disturbate_");
		printTableVectorsWithPrefix("invalid_guards_",false,destFile,"disturbate_");
		printTableVectorsWithPrefix("missing_clocks_",false,destFile,"disturbate_");
		
		printTableVectorsWithPrefix("config_accepted_",false,destFile,"disturbate_");
		printTableVectorsWithPrefix("config_notAccepted_",false,destFile,"disturbate_");
		
		printTableVectorsWithPrefix("config_avgAccepted_",false,destFile,"disturbate_");
		printTableVectorsWithPrefix("config_avgNotAccepted_",false,destFile,"disturbate_");
		
		printTableVectorsWithPrefix("config_invalid_guards_",false,destFile,"disturbate_");
		
		printTableVectorsWithPrefix("config_invalid_events_",false,destFile,"disturbate_");
		printTableVectorsWithPrefix("config_invalid_guards_",false,destFile,"disturbate_");
		printTableVectorsWithPrefix("config_missing_clocks_",false,destFile,"disturbate_");
		}
...
//		getFromIntegerListMap( getIntegerMap("automataTransitions_"+prj) ,"_").add(transitions);
	...
	private static void updateWithDataInFile(File results)
		...
		while ( ( line = br.readLine() ) != null ){
			...
			Integer nonFinalState = Integer.valueOf( c[i++] );

			if ( totalInvalidEvents + totalInvalidGuards + missingClocks + nonFinalState != totalInvalid ){
...
//			}
			...
			getFromIntegerListMap( getIntegerMap("notAccepted_") ,runs).add((double)totalInvalidEvents+totalInvalidGuards+missingClocks+nonFinalState);
			...
			getFromIntegerListMap( getIntegerMap("nonFinalState_") ,runs).add((double)nonFinalState);
			...
			getFromIntegerListMap( getIntegerMap("config_notAccepted_") ,key).add((double)totalInvalidEvents+totalInvalidGuards+missingClocks+nonFinalState);
			...
			getFromIntegerListMap( getIntegerMap("config_nonFinalState_") ,key).add((double)nonFinalState);
